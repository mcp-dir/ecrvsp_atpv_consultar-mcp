...
ECRVSP ATPV (Intenção de Venda): Consultar segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [ecrvsp_atpv_consultar@mcp.ai](mailto:ecrvsp_atpv_consultar@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
